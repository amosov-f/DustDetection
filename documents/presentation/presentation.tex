...
\begin{document}
    ...
    \section{Зависимость покраснения от расстояния}    
        ...
        \begin{frame}{Идеальная кривая покраснения}
            \begin{center}
                \includegraphics[scale=0.35]{ideal-1.png}
            \end{center}             
        \end{frame}
        ...
        \begin{frame}{Пылевые облака}
            \begin{center}
                \includegraphics[scale=0.35]{ideal-2.png}
            \end{center}             
        \end{frame}
        
        \begin{frame}{Реальное покраснение}
            \begin{center}
                \includegraphics[scale=0.23]{real-1.png}
            \end{center}             
        \end{frame}
        
        \begin{frame}{Реальная <<кривая>> покраснения}
            \begin{center}
                \includegraphics[scale=0.23]{real-2.png}
            \end{center}             
        \end{frame}
        
        \begin{frame}{Отрицательный тренд}
            \begin{center}
                \includegraphics[scale=0.23]{real-3.png}
            \end{center}             
        \end{frame}
        
    \section{Карты}            
        
        \begin{frame}{Распределение коэффициента $a$}
            \begin{center}
                \includegraphics[scale=0.32]{map-a.png}
            \end{center}             
        \end{frame}
        
        \begin{frame}{Распределение коэффициента $b$}
            \begin{center}
                \includegraphics[scale=0.32]{map-b.png}
            \end{center}             
        \end{frame}
    ...
    \section{Предварительная обработка}                
        ...
        \begin{frame}{Наличие классов светимости}
            \begin{center}
                \includegraphics[scale=0.32]{count.png}
            \end{center}             
        \end{frame}
    ...
    \section{Определение классов светимости}                
        ...
        \begin{frame}{Обучающее множество}
            \begin{center}
                \includegraphics[scale=0.23]{ml-1.png}
            \end{center}             
        \end{frame}
        
        \begin{frame}{Результат классификации}
            \begin{center}
                \includegraphics[scale=0.23]{ml-2.png}
            \end{center}             
        \end{frame}
